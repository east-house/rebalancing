import { BarChart3, BriefcaseBusiness, GitCompareArrows } from "lucide-react";

import "./productTabs.css";

export type ProductTab = "portfolio" | "portfolio-report" | "etf-compare";
...
export default function ProductTabs({
  ...
  return (
    <nav className="product-tabs" aria-label="포트폴리오 도구">
